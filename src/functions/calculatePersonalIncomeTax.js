export const calculatePersonalIncomeTax = (taxableIncome) =>{
    ...
    if(currentTaxableIncome <= 0){
      ...
      if(taxableIncome <= 5000000){
        ...
        return{
          fivePercent: Math.round(personalIncomeTax),
          tenPercent: 0,
          fifteenPercent: 0,
          twentyPercent: 0,
          twentyFivePercent: 0,
        ...
        if(taxableIncome > 18000000 && taxableIncome <= 32000000){
          ...
          return{
            ...
            twentyPercent: Math.round(twentyPercent),            
            twentyFivePercent: 0,
            thirtyPercent: 0,
            thirtyFivePercent: 0,
            totalPersonIncomeTax: personalIncomeTax
        ...
        if(taxableIncome > 32000000 && taxableIncome <= 52000000){
          ...
          return{
            ...
            twentyFivePercent: Math.round(twentyFivePercent),
            thirtyPercent: 0,
            thirtyFivePercent: 0,
            totalPersonIncomeTax: personalIncomeTax
          }
        ...
        if(taxableIncome > 80000000){
          ...
          return{
            ...
            thirtyFivePercent: Math.round(thirtyFivePercent),
            totalPersonIncomeTax: personalIncomeTax
          }
        }
      }
